...
function addcart(productImg, productName, productPrice) {
  ...
  sizeM.addEventListener("click", function () {
    sizeSPrice.innerHTML = sizeSPriceA * 1000 + 20000;
  });
  sizeL.addEventListener("click", function () {
    sizeSPrice.innerHTML = sizeSPriceA * 1000 + 40000;
  });
  sizeS.addEventListener("click", function () {
    sizeSPrice.innerHTML = sizeSPriceA * 1000;
  });
}
...
function cartTotal() {
  ...
  cartTotalA.innerHTML = totalC * 1000;
  inputChange();
}

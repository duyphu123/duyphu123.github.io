...
const deleteProduct = (id) => {
  ...
  for (i = 0; i < cartProduct.length; i++) {
    ...
    // btnDelete[i].addEventListener("click", function (event) 
      ...
      var ItemDeleteA = ItemDelete.parentElement.parentElement.parentElement.parentElement;
      
      var productImg = ItemDeleteA.querySelector("img").src;
      
      
      var productName = ItemDeleteA.querySelector(".name-thanhtoan").innerText;
